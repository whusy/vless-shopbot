...
```bash
curl -sSL https://raw.githubusercontent.com/evansvl/vless-shopbot/main/install.sh | bash
```
...
*(Замените your-domain.com на ваш домен. Если при установке вы выбрали порт 8443, укажите его: https://your-domain.com:8443/yookassa-webhook)*
